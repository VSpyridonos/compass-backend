...
const seedDB = async () => {
    ...
    let measurement11 = new Measurement({ user: user1.id, x: 39.67284741191457, y: 20.85578510919271, speed: 2.5 });
    ...
    let measurement21 = new Measurement({ user: user1.id, x: 39.67277236358999, y: 20.85599659510648, speed: 2.5 });
    ...
    let measurement31 = new Measurement({ user: user1.id, x: 39.67275171854355, y: 20.85618703193917, speed: 2.5 });
    ...
    let measurement41 = new Measurement({ user: user1.id, x: 39.6726546867428, y: 20.856516943635236, speed: 2.5 });
    ...
    let measurement51 = new Measurement({ user: user1.id, x: 39.6726588157583, y: 20.856811986615459, speed: 2.5 });
    ...
    let measurement61 = new Measurement({ user: user1.id, x: 39.6727290089854, y: 20.857093618551134, speed: 2.5 });
    ...
    let measurement71 = new Measurement({ user: user1.id, x: 39.6727579120582, y: 20.857195542489756, speed: 2.5 });
    ...
    let measurement81 = new Measurement({ user: user1.id, x: 39.6728363631948, y: 20.857501314305623, speed: 2.5 });
    ...
    let measurement91 = new Measurement({ user: user1.id, x: 39.6728611372194, y: 20.857605920453158, speed: 2.5 });
    ...
    let measurement101 = new Measurement({ user: user1.id, x: 39.672989136205, y: 20.857965336447254, speed: 2.5 });
